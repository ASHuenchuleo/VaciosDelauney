...
int main(int argc, char **argv)
{
	...
	printf("* %d triángulos\n", tnumber);
	printf("* %d puntos\n", pnumber);
	elapsed = print_timestamp("Preparando para procesamiento paralelo...\n", t);
	fprintf(sfd, "cmix %d %d %lf ", pnumber, tnumber, elapsed);
	...
	elapsed = print_timestamp("Ejecutando primera fase de kerneles...\n", t);
	...
	clFinish(command_queue);
	elapsed = print_timestamp("Ejecutando fase secuencial...\n", t);
	fprintf(sfd, "%lf ", elapsed);
	...
	clFinish(command_queue);
	elapsed = print_timestamp("Ejecutando última fase de kerneles...\n", t);
	fprintf(sfd, "%lf ", elapsed);
